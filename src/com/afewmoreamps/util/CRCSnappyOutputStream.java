 ...
 * Snappy with CRC verification applied after compression.
 *
 ...
 *
 */
public class CRCSnappyOutputStream extends OutputStream
{
    ...
    public CRCSnappyOutputStream(OutputStream out, FileChannel fchannel) throws IOException {
        this(new BufferedOutputStream(out, 128 * 1024), fchannel, DEFAULT_BLOCK_SIZE);
    }
     ...
     * @throws IOException
     */
    public CRCSnappyOutputStream(OutputStream out, FileChannel fchannel, int blockSize) throws IOException {
        this.out = out;
        this.fchannel = fchannel;
        fchannel.position(4);//skip crc which isn't calculated yet
    ...
    protected void dump() throws IOException {
        ...
        intBuffer.clear();
        intBuffer.putInt(compressedSize);
        crc.update(intBuffer.array());
        out.write(intBuffer.array());
        crc.update(compressed, 0, compressedSize);
    ...
    public void close() throws IOException {
        flush();
        fchannel.position(0);
        intBuffer.putInt( 0, (int)crc.getValue());
        intBuffer.flip();
        while (intBuffer.hasRemaining()) {
            fchannel.write(intBuffer);
        }
