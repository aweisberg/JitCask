 ...
 * @since 1.0
 */
public final class KeyDirUnsignedBytes {
  private KeyDirUnsignedBytes() {}
  ...
  static class LexicographicalComparatorHolder {
    ...
    enum UnsafeComparator implements Comparator<byte[]> {
      ...
      @Override public int compare(byte[] left, byte[] right) {
        int minLength = Math.min(left.length - 17, right.length - 17);
    ...
    public static void main(String args[]) throws Exception {
        Comparator<byte[]> c = KeyDirUnsignedBytes.lexicographicalComparator();
        byte a[] = new byte[18];
        a[0] = 10;
        a[1] = 12;
        byte b[] = new byte[18];
